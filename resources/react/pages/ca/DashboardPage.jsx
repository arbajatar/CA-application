...
function SummaryCard({ icon: Icon, iconBg, label, value, sub, subColor }) {
    return (
...
export default function DashboardPage() {
    ...
    const cards = [
        { icon: FileText, iconBg: 'bg-blue-400', label: 'Total Tasks', value: summary?.total_tasks ?? 0, sub: 'All time records' },
        { icon: Activity, iconBg: 'bg-sky-400', label: 'Active Tasks', value: summary?.active_tasks ?? 0, sub: 'In current workflow' },
        { icon: CheckCircle, iconBg: 'bg-green-400', label: 'Completed', value: summary?.completed_this_month ?? 0, sub: 'This month' },
        { icon: AlertTriangle, iconBg: 'bg-red-400', label: 'Overdue', value: 0, sub: 'Immediate action req.', subColor: 'text-red-500' },
        { icon: Briefcase, iconBg: 'bg-indigo-400', label: 'Total Clients', value: summary?.total_clients ?? 0, sub: 'Enterprise level' },
        { icon: Users, iconBg: 'bg-teal-400', label: 'Total Staff', value: summary?.total_staff ?? 0, sub: 'Full-time active' },
    ]
