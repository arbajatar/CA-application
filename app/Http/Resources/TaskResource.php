...
class TaskResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'is_billable' => $this->is_billable ?? (bool)($this->dynamic_fields['is_billable'] ?? false),
            'is_after_sales' => $this->is_after_sales ?? (bool)($this->dynamic_fields['is_after_sales'] ?? false),
            'allow_duplicate_clients' => $this->allow_duplicate_clients ?? (bool)($this->dynamic_fields['allow_duplicate_clients'] ?? false),
